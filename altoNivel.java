...
public class altoNivel {
    ...
    public static void main(String[] args){
        Scanner in = new Scanner(System.in);
         int i=0;
         int x=0;
     System.out.println("Programa de Raiz Quadrada - Newton-Raphson\r\n" + "Desenvolvedoras: Eduarda Patricio, Giovanna Castro, Naiumy dos Reis e Yasmin Aguirre");

        while (true){
            System.out.println("Digite os parâmetros x e i para calcular sqrt_nr (x, i) ou -1 para abortar a execução");
